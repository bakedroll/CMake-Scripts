macro(find_required_library)
  ...
  if (NOT EXISTS ${AVCPP_INCLUDE_DIRECTORY})
    if (EXISTS "/usr/local/include/avcpp")
      unset(AVCPP_INCLUDE_DIRECTORY CACHE)
      set(AVCPP_INCLUDE_DIRECTORY "/usr/local/include" CACHE PATH "")
    endif()
  endif()

  if (NOT EXISTS ${AVCPP_LIBRARY})
    if (EXISTS "/usr/local/lib/libavcpp.so")
      unset(AVCPP_LIBRARY CACHE)
      set(AVCPP_LIBRARY "/usr/local/lib/libavcpp.so" CACHE PATH "")
    endif()
  endif()
